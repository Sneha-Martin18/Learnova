...
class AddStudentForm(forms.Form):
    ...
    try:
        ...
        for session in session_years:
            session_list.append((session.id, f"{session.session_start_year} to {session.session_end_year}"))
    except:
        session_list = []
    ...
    def __init__(self, *args, **kwargs):
        ...
        try:
            ...
            self.fields['student_id'].choices = [
                (str(student.admin.id), f"{student.admin.first_name} {student.admin.last_name} - {student.course_id.course_name}")
