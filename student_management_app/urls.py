...
urlpatterns = [
    ...
    path('change_own_password/', HodViews.change_own_password, name='change_own_password'),
    path('delete_incomplete_student/<str:user_id>', HodViews.delete_incomplete_student, name="delete_incomplete_student"),
    path('delete_incomplete_staff/<str:user_id>', HodViews.delete_incomplete_staff, name="delete_incomplete_staff"),
    # URLS for Staff
    ...
    # Assignment URLs
    path('manage_assignments/', StaffViews.manage_assignments, name='staff_manage_assignments'),
    path('add_assignment/', StaffViews.add_assignment, name='staff_add_assignment'),
    path('add_assignment_save/', StaffViews.add_assignment_save, name='staff_add_assignment_save'),
    path('delete_assignment/<int:assignment_id>/', StaffViews.delete_assignment, name='staff_delete_assignment'),
    path('view_assignment_submissions/<int:assignment_id>/', StaffViews.view_assignment_submissions, name='staff_view_submissions'),
    ...
    path('student_view_fines/', StudentViews.student_view_fines, name='student_view_fines'),
    path('student/initialize_payment/<int:fine_id>/', StudentViews.initialize_payment, name='initialize_payment'),
    path('student/payment_callback/', StudentViews.payment_callback, name='payment_callback'),
    ...
    path('student/assignments/', StudentViews.view_assignments, name="student_view_assignments"),
    path('student/assignment/<int:assignment_id>/submit/', StudentViews.submit_assignment, name="student_submit_assignment"),
